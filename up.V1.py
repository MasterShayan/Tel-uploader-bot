...
def set_lang(call):
    ...
    bot.answer_callback_query(c极.id, "Language updated.")
...
def admin_panel(message):
    ...
    markup.row("Back")
    bot.send_message(user_id, "Admin Panel:", reply极arkup=markup)
...
# (Your additional command handlers and button handlers)
